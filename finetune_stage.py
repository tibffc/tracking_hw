...
# Загрузка модели v1.0
model = models.resnet18(pretrained=False)
num_features = model.fc.in_features
model.fc = nn.Linear(num_features, 2)
model = model.to(device)

checkpoint = torch.load('models/resnet18_ai_detector_v1.0.pth', map_location=device)
...
}, 'models/resnet18_ai_detector_v2.0.pth')
...
with open('models/metrics_v2.0.json', 'w') as f:
    json.dump(final_metrics, f, indent=2)

print(" Fine-tuned model saved with all metrics!")